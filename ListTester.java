...
// Step 5 Bookmark
			...
			printTest(scenarioName + "_iterNext_iterNext_iterNext_testIterNext", testIterNext(WrapIt.prep(scenario.build()).next().next().next().getIterator(), contents[2], Result.NoSuchElement));
